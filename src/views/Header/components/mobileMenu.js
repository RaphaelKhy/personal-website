  ...
  return (
    <StyledMobileMenu isTransition={isTransition}>
      ...
      <nav className={'mobile-nav ' + (isMobileMenuActive ? 'is-active' : null)}>
        <a href="/#experience" onClick={(e) => handleNavClick(e, setIsMobileMenuActive)}>
          Experience
        </a>
        <a href="/#projects" onClick={(e) => handleNavClick(e, setIsMobileMenuActive)}>
          Projects
        </a>
        <a href="/#contact" onClick={(e) => handleNavClick(e, setIsMobileMenuActive)}>
          Contact
        </a>
      </nav>
    </StyledMobileMenu>
